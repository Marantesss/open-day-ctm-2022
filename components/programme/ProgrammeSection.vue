<template>
  <div class="container mx-auto my-6">
      <h1 class="text-4xl uppercase mb-4">/Programme</h1>
        <div class="grid grid-cols-2 gap-5 items-start">
            <div class="text-center grid grid-cols-1 gap-2 items-start">
                <h3 class="text-xl text-blue-500 font-bold">March 31st</h3>
                <ProgrammeCard
            ...
            <div class="text-center grid grid-cols-1 gap-2 items-start">
                <h3 class="text-xl text-blue-500 font-bold">April 1st</h3>
                <ProgrammeCard
    ...
    data() {
        return {
            day1: [
                ...
                {
                    name: 'Como fazer croquetes',
                    time: '15:00',
                    day: 'March 31st',
                    place: 'Cantina da FEUP',
                    speakers: [
                        {
