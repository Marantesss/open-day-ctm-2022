<template>
  <div id="speakers" class="container mx-auto my-6 px-2">
    ...
    >
      <SpeakerCard
        ...
        :img="`images/speakers/${speaker.img}`"
      />
    </div>
  </div>
</template>
      ...
      speakers: [
        {
          ...
          social: [
            {
              name: 'linkedin',
              url: 'https://www.linkedin.com/in/eduardonalmeida/',
            },
          ],
        },
        {
